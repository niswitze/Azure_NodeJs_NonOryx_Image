#DEMO IMAGE
#This image is based on the official Azure node image for Linux based Web Apps and can be found here -> https://github.com/Azure-App-Service/node
#and is to be only used for reference/demo purposes
